...
class SeboMessages
{
	...
	const NEGATIVE_AMOUNT_FORBIDDEN = "Stop right there criminal scum! Negative amount is forbidden!";
	const ZERO_AMOUNT_FORBIDDEN = "You violated the law... You cannot add 0 amount.";
